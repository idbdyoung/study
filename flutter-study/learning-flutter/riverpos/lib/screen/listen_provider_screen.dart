...
import 'package:riverpos/riverpod/listen_provider.dart';
...
class _ListenProviderScreenState extends ConsumerState<ListenProviderScreen>
  ...
  void initState() {
    ...
    controller = TabController(length: 10, vsync: this, initialIndex: ref.read(listenProvider.notifier).state);
  }
